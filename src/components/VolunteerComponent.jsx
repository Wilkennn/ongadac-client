...
const VolunteerComponent = ({ searchText }) => {
    ...
    useEffect(() => {
        const fetchVoluntarios = async () => {
            try {
                const response = await axios.get('https://ongadac-server.vercel.app/api/usuario/voluntarios');
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`https://ongadac-server.vercel.app/api/usuario/${id}/voluntario`);

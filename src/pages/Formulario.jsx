...
const Formulario = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        // Buscar dados do pet
        if (petId) {
          const petResponse = await fetch(`https://ongadac-server.vercel.app/api/pet/${petId}`);
          if (petResponse.ok) {
        ...
        if (usuarioId) {
          const userResponse = await fetch(`https://ongadac-server.vercel.app/api/usuario/${usuarioId}`);
          if (userResponse.ok) {
  ...
  const enviarFormulario = async () => {
    ...
    try {
      ...
      const response = await fetch('https://ongadac-server.vercel.app/api/adocao/', {
        method: 'POST',
        headers: {
